...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig()
                        .setOutputDir("F:\\workspace\\papaya-security\\papaya-generator\\src\\main\\java\\com\\papaya\\generator\\generatorDir" )//输出目录
                ...
                new DataSourceConfig()
                        ...
                        .setUrl( "jdbc:mysql://172.19.50.147:3306/zituo?useUnicode=yes" )
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                        ...
                        .setInclude( new String[]{ "xft_broker_org_building" } ) // 需要生成的表
                ...
                new PackageConfig()
                        // .setModuleName( "test" )
                        .setParent( "com.papaya.front" )// 自定义包路径
