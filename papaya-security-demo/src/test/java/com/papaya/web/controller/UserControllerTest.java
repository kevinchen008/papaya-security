package com.papaya.web.controller;
...
public class UserControllerTest {
    ...
    public void whenGetInfoFailed() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.patch("/user/a")
                .contentType(MediaType.APPLICATION_JSON_UTF8))
    ...
    public void fileUploadSuccess() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.fileUpload("/file")
                .file(new MockMultipartFile("file","hello.txt","multipart/form-data","hello file".getBytes())))
                .andExpect(MockMvcResultMatchers.status().isOk());
    }
}
